...
from ..utilities._subsetting_functions import _isolate_trajectory
    
def _check_loss_whole_trajectory(adata, validation_data_object, use_embedding):
...
def _check_loss_coarse(adata):
    ...
    with torch.no_grad():
        ...
        for traj in unique_val_trajs:
            ...
            isolated_traj = _isolate_trajectory(adata, traj)
