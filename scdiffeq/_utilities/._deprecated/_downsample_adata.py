...
from ..plotting._plotting_presets import _presets_for_plotting_multiple_trajectories
import warnings
import numpy as np
...
def _plot_downsampled(adata, title="Simulated Data", figsize=(10, 8)):
    ...
    for i in trajs:
        ...
        _presets_for_plotting_multiple_trajectories(
            ax, title, data[:, 0], data[:, 1], "x", "y",
        )


def _downsample_adata(adata, percentage_of_data=1, random=False, plot=False):
