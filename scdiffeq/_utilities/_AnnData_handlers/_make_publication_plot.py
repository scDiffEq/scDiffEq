...
def _make_spontaneous_figure_dir_figname(
    scdiffeq_figures_dir="scdiffeq_figures", extension="pdf"
):
...
def _make_publication_plot(
    figsave_path=None, scdiffeq_figures_dir="scdiffeq_figures", extension="pdf"
):
    ...
    if figsave_path == None:
        figsave_path = _make_spontaneous_figure_dir_figname(
            scdiffeq_figures_dir=scdiffeq_figures_dir, extension=extension
        )
