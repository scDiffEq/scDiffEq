...
def specify_func(data_dimensionality, layers, nodes):
    ...
    func = ODEFunc(data_dimensionality, layers, nodes).to(set_device())

    return func


def load_model(path, data_dimensionality, layers, nodes):
    ...
    model = specify_func(data_dimensionality, layers, nodes)
