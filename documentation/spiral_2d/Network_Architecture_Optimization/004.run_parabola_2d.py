...
OUTPATH = (
    "/home/mvinyard/results/scdiffeq/parabola_2d/neural_ODEs/run004_network_architecture_analysis/"
    + "004."
    + str(N_LAYERS)
    + "_"
    + str(N_NODES)
...
Simulation.get_initial_conditions(
    loc=0, scale=2, size=[N_TRAJ, 2], plot=True,
...
#### SETUP DIFFEQ ####
DiffEq = sdq.tl.scDiffEq(
    n_layers=N_LAYERS, outdir=OUTPATH, nodes_n=N_NODES, nodes_m=N_NODES
)
